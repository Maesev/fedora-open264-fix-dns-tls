...
> **Note:** This project is a fork/extension based on the original work by [supertico](https://github.com/supertico/fedora-open264-geoblock-fix.git).
...
> **Примечание:** Этот проект является форком/расширением, основанным на оригинальной работе [supertico](https://github.com/supertico/fedora-open264-geoblock-fix.git).
